...
This README describes the current V2 preview source. The latest downloadable release is [v0.0.3](https://github.com/devilcoolyue/cursor-dashboard/releases/tag/v0.0.3); its exact contents are listed in the [release archive](docs/archive/v0.0.3.md). Screenshots use synthetic preview data.
...
Download the package for your platform from **[v0.0.3 Releases](https://github.com/devilcoolyue/cursor-dashboard/releases/tag/v0.0.3)**:

| Platform | Download |
| --- | --- |
| macOS · Apple Silicon | [DMG for arm64](https://github.com/devilcoolyue/cursor-dashboard/releases/download/v0.0.3/Cursor.Panel_0.0.3_aarch64.dmg) |
| macOS · Intel | [DMG for x64](https://github.com/devilcoolyue/cursor-dashboard/releases/download/v0.0.3/Cursor.Panel_0.0.3_x64.dmg) |
| Windows · x64 | [Installer for x64](https://github.com/devilcoolyue/cursor-dashboard/releases/download/v0.0.3/Cursor.Panel_0.0.3_x64-setup.exe) |
...
- **Updates require published update packages.** Source includes update checks and signed update support. Signed update packages are included in v0.0.3; server upgrades also need the optional Linux amd64 host updater. Users of v0.0.1 must install v0.0.2 manually once to get the updater. See [automatic updates](docs/automatic-updates.md).
