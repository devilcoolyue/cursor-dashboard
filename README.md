...
This README describes the current V2 preview source. The latest downloadable release is [v0.0.5](https://github.com/devilcoolyue/cursor-panel/releases/tag/v0.0.5); its exact contents are listed in the [release archive](docs/archive/v0.0.5.md). Screenshots use synthetic preview data.
...
Download the package for your platform from **[v0.0.5 Releases](https://github.com/devilcoolyue/cursor-panel/releases/tag/v0.0.5)**:

| Platform | Download |
| --- | --- |
| macOS · Apple Silicon | [DMG for arm64](https://github.com/devilcoolyue/cursor-panel/releases/download/v0.0.5/Cursor.Panel_0.0.5_aarch64.dmg) |
| macOS · Intel | [DMG for x64](https://github.com/devilcoolyue/cursor-panel/releases/download/v0.0.5/Cursor.Panel_0.0.5_x64.dmg) |
| Windows · x64 | [Installer for x64](https://github.com/devilcoolyue/cursor-panel/releases/download/v0.0.5/Cursor.Panel_0.0.5_x64-setup.exe) |
...
- **Updates require published update packages.** Source includes update checks and signed update support. Signed update packages are included in v0.0.5; server upgrades also need the optional Linux amd64 host updater. Users of v0.0.1 must install v0.0.2 manually once to get the updater. See [automatic updates](docs/automatic-updates.md).
