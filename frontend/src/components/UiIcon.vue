...
<template><component :is="icon" :size="size" :stroke-width="1.65" class="ui-icon" aria-hidden="true" focusable="false" /></template>
<style>
.ui-icon { display: block; flex-shrink: 0; vertical-align: middle; }
</style>
