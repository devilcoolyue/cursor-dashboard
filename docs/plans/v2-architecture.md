...
状态：P0、P1、P2、P3、P4 开发与阶段自动验证已完成，结果见 [P0 验证报告](p0-verification.md)、[P1 验证报告](p1-verification.md)、[P2 验证报告](p2-verification.md)、[P3 验证报告](p3-verification.md)、[P4 验证报告](p4-verification.md)；P5 连接与设备会话实现及本机模拟验证见 [P5 报告](p5-verification.md)，真实上游远程切换仍待验证；P6 待实施。本文描述目标设计，各阶段可用入口及边界以验证报告为准。
...
- [x] 验证服务离线、权限撤销、会话到期、重复领取、切换中断和协议不兼容的恢复路径（本机自动验证，新增平台验证边界见报告）。
