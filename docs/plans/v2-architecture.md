...
状态：P0、P1 已完成，结果见 [P0 验证报告](p0-verification.md)、[P1 验证报告](p1-verification.md)；P2 已实现并通过本地验证，跨平台结果见 [P2 验证报告](p2-verification.md)；P3–P6 待实施。本文描述目标设计，各阶段可用入口及边界以验证报告为准。
...
P2 提供独立 `cursor-api` 和本地首次管理员初始化，见[运行说明](../v2-api-operations.md)。切换票据签发/原子领取在共用核心验证；P3 Web 交付和 P5 设备会话适配尚未开放，API 不返回裸凭证。
