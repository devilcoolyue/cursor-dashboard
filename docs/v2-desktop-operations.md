...
P4 桌面使用本机数据库与系统凭证库，不需要先部署 Cursor Panel 服务端。安装产物、平台实测及已知边界见 [P4 验证报告](plans/p4-verification.md)。当前版本为 `1.4.0`，P5 远程连接已接入，使用与限制见 [连接实例说明](v2-connected-operations.md)；真实远程切换验证和 P6 正式签名发行尚未完成。
